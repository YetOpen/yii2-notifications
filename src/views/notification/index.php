...
<div class="notifications-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            'type' => [
                'attribute' => 'type',
                'filter' => NotificationType::getAllName()->column(),
                'filterInputOptions' => [
                    'class' => 'form-control',         
                    'prompt' => 'All'
                ],
            ...
            'managed' => [
                ...
                'editableOptions'=> function($model, $key, $index, $column){
                    //if the check_management is set to 0 the button is disabled
                    $editableButtonOption= ($model->notificationType->check_management==0 ? TRUE:FALSE);
                        return [
